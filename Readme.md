...
* <a href="interactive_analysis.py">interactive_analysis.py</a>. This file support interactive inspection of the points in the PCA space (on click visualization). It exploits pre-computed CLIP's embeddings, provided below. 
